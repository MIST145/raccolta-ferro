Here's the code with the Italian informational text translated into English:
...
Config.RequiredItem = 'extractor'

Config.Debug = true

Config.Timings = {
    ["Extractor"] = math.random(4000, 5000),
    ["IronRespawn"] = math.random(8000, 8500),
}
